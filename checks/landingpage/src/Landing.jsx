...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
      {/* Header Section */}
          ...
          <div className="relative z-10 p-8 sm:p-10">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center text-slate-900">
                ...
                <span>Grade and provide feedback</span>
              </div>
            </div>
